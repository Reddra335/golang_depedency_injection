...
func SetupTestDB() *sql.DB {
	...
	db, err := sql.Open("mysql", "root@tcp(localhost:3306)/belejar_golang_restful_api_test")
...
func TestCreateCategorySuccess(t *testing.T) {
	...
	requestBody := strings.NewReader(`{"name":"Rendi"}`)
	...
	assert.Equal(t, "Rendi", responseBody["data"].(map[string]any)["name"])
}
